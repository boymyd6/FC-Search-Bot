class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},ɪ ᴀᴍ ɴᴇxᴛ ɢᴇɴᴇʀᴀᴛɪᴏɴ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ᴡɪᴛʜ ʟɪɴᴋ sʜᴏʀᴛᴇɴᴇʀ ʙᴏᴛ ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a>,ᴊᴜꜱᴛ ᴀᴅᴅ ᴍᴇ ᴀꜱ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇʀᴇ ᴍᴏᴠɪᴇꜱ ᴡɪᴛʜ ʏᴏᴜʀ ʟɪɴᴋꜱʜᴏʀᴛᴇɴᴇʀ</b>"""
