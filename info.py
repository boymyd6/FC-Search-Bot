...
URL = "https://autofilmbot-hepe.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilmbot-hepe.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilmbot-hepe.onrender.com/".format(FQDN)
else:
    URL = "https://autofilmbot-hepe.onrender.com/".format(FQDN)
