...
BOT_TOKEN = environ.get('BOT_TOKEN', "7132687729:AAEoBcCl0DUnMXqlt7K2HsDzLGrOIEHEaAs")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/b429b2eabd898da11984a.jpg')).split()
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filmclan:Xi2JMC7YSXk1YOFw@cluster0.mvjljxf.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "filmclan")
...
URL = "https://filmclan-ooud.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filmclan-ooud.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filmclan-ooud.onrender.com/".format(FQDN)
else:
    URL = "https://filmclan-ooud.onrender.com/".format(FQDN)
