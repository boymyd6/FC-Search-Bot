...
BOT_TOKEN = environ.get('BOT_TOKEN', "5907438024:AAG6iujoopeBamMDoyJgU9R5KI4XCI4NNxk")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/b3eb155afa7a1a3ca7834.jpg')).split()
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/FilmClanBot?start=ZmlsZV9CQUFEQlFBRDdROEFBaWtvVUZUREp6UkI1WW1SS1JZRQ')
...
URL = "https://autofilmbot-vwpi.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilmbot-vwpi.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilmbot-vwpi.onrender.com/".format(FQDN)
else:
    URL = "https://autofilmbot-vwpi.onrender.com/".format(FQDN)
