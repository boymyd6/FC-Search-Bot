...
URL = "https://autobot-imxm.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autobot-imxm.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autobot-imxm.onrender.com/".format(FQDN)
else:
    URL = "https://autobot-imxm.onrender.com/".format(FQDN)
