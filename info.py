...
URL = "https://v2-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://v2-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://v2-bot.onrender.com/".format(FQDN)
else:
    URL = "https://v2-bot.onrender.com/".format(FQDN)
