...
URL = "https://autofilmbot-pj4l.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilmbot-pj4l.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilmbot-pj4l.onrender.com/".format(FQDN)
else:
    URL = "https://autofilmbot-pj4l.onrender.com/".format(FQDN)
