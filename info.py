...
SPELL_IMG = bool(environ.get("SPELL_IMG", False))
...
LANGUAGES = ["malayalam", "mal", "tamil", "tam" ,"english", "eng", "hindi", "hin", "telugu", "tel", "kannada", "kan", "Urdu", "Bangla", "Marathi", "Gujarati", "dual", "multi"]
...
URL = "https://filmclan-xgn0.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filmclan-xgn0.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filmclan-xgn0.onrender.com/".format(FQDN)
else:
    URL = "https://filmclan-xgn0.onrender.com/".format(FQDN)
