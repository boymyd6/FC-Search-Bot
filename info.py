...
URL = "https://autofilmbot-4n0q.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilmbot-4n0q.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilmbot-4n0q.onrender.com/".format(FQDN)
else:
    URL = "https://autofilmbot-4n0q.onrender.com/".format(FQDN)
