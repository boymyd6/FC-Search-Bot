...
URL = "https://kdbot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kdbot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://kdbot.onrender.com/".format(FQDN)
else:
    URL = "https://kdbot.onrender.com/".format(FQDN)
