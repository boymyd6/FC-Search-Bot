...
URL = "https://filmclan-jjky.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filmclan-jjky.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filmclan-jjky.onrender.com/".format(FQDN)
else:
    URL = "https://filmclan-jjky.onrender.com/".format(FQDN)
