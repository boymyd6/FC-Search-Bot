...
PICS = (environ.get('PICS', 'https://graph.org/file/20d78b2034e4fb8f3ef87.jpg')).split()
...
URL = "https://autofilmbot-yyz5.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilmbot-yyz5.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilmbot-yyz5.onrender.com/".format(FQDN)
else:
    URL = "https://autofilmbot-yyz5.onrender.com/".format(FQDN)
