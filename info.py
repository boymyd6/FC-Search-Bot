...
URL = "https://autobot-3zy9.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autobot-3zy9.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autobot-3zy9.onrender.com/".format(FQDN)
else:
    URL = "https://autobot-3zy9.onrender.com/".format(FQDN)
