...
PICS = (environ.get('PICS', 'https://graph.org/file/d7e8e245ede2f176998c1.jpg')).split()
...
URL = "https://autofilmbot-occ0.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilmbot-occ0.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilmbot-occ0.onrender.com/".format(FQDN)
else:
    URL = "https://autofilmbot-occ0.onrender.com/".format(FQDN)
