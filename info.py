...
URL = "https://autofilm-oi90.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilm-oi90.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilm-oi90.onrender.com/".format(FQDN)
else:
    URL = "https://autofilm-oi90.onrender.com/".format(FQDN)
