...
BOT_TOKEN = environ.get('BOT_TOKEN', "5907438024:AAHUque6TfwyysxcEJtb8APh4PyKLmrHPjo")
...
URL = "https://filmclan-26yn.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filmclan-26yn.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filmclan-26yn.onrender.com/".format(FQDN)
else:
    URL = "https://filmclan-26yn.onrender.com/".format(FQDN)
