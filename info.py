...
URL = "https://filmclan.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filmclan.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filmclan.onrender.com/".format(FQDN)
else:
    URL = "https://filmclan.onrender.com/".format(FQDN)
