...
URL = "https://bot-laee.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://bot-laee.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://bot-laee.onrender.com/".format(FQDN)
else:
    URL = "https://bot-laee.onrender.com/".format(FQDN)
