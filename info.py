...
URL = "https://myd-boy.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://myd-boy.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://myd-boy.onrender.com/".format(FQDN)
else:
    URL = "https://myd-boy.onrender.com/".format(FQDN)
