...
URL = "https://autofilm3.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilm3.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilm3.onrender.com/".format(FQDN)
else:
    URL = "https://autofilm3.onrender.com/".format(FQDN)
