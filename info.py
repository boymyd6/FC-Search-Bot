...
URL = "https://mydboy-v1.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mydboy-v1.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://mydboy-v1.onrender.com/".format(FQDN)
else:
    URL = "https://mydboy-v1.onrender.com/".format(FQDN)
