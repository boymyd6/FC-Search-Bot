...
URL = "https://autofcbot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofcbot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofcbot.onrender.com/".format(FQDN)
else:
    URL = "https://autofcbot.onrender.com/".format(FQDN)
