...
URL = "https://demo-28lq.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demo-28lq.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demo-28lq.onrender.com/".format(FQDN)
else:
    URL = "https://demo-28lq.onrender.com/".format(FQDN)
