...
BOT_TOKEN = environ.get('BOT_TOKEN', "7081077687:AAGhPUXWbC_c56MIslgnroKiAuHvfwe8pGA")
...
URL = "https://filmclan-2lem.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filmclan-2lem.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filmclan-2lem.onrender.com/".format(FQDN)
else:
    URL = "https://filmclan-2lem.onrender.com/".format(FQDN)
