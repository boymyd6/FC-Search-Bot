...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n𝟷. Aᴅᴅ Mᴇ ɪɴ Yᴏᴜʀ Gʀᴏᴜᴘ ᴡɪᴛʜ Fᴜʟʟ Aᴅᴍɪɴ Rɪɢʜᴛs\n\n𝟸. Aғᴛᴇʀ Aᴅᴅɪɴɢ ɪɴ ɢʀᴏᴜᴘ, Sᴇᴛ ʏᴏᴜʀ Sʜᴏʀᴛᴇɴᴇʀ\n\nSᴇɴᴅ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ\n\n—> /shortlink {ʏᴏᴜʀ_sʜᴏʀᴛᴇɴᴇʀ_ᴡᴇʙsɪᴛᴇ_ɴᴀᴍᴇ} {ʏᴏᴜʀ_sʜᴏʀᴛᴇɴᴇʀ_ᴀᴘɪ}\n\n#Sample:-\n/shortlink omegalinks.in 4b392f8eb6ad711be58\n\nTʜᴀᴛ's ɪᴛ!!! Eɴɪᴏʏ Eᴀʀɴɪɴɢ Mᴏɴᴇʏ 💲💸\n\nTʀᴜsᴛᴇᴅ Eᴀʀɴɪɴɢ Sɪᴛᴇ - omegalinks.in\n\nIғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ Dᴏᴜʙᴛs, Fᴇᴇʟ Fʀᴇᴇ ᴛᴏ Asᴋ ᴍᴇ - @Maidi_King\n\nPᴜʀɪʏᴀʟᴀ ɴᴀ ɪɴᴛʜᴀ ᴄᴏɴᴛᴀᴄᴛ ʟᴀ ᴍᴇssᴀɢᴇ ᴘᴀɴɴᴜɴɢᴀ - @Maidi_King</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
