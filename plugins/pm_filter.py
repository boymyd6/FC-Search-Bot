...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @creatorrio
        ...
        await query.message.edit_text(
            ...
            InlineKeyboardButton("Dᴜᴀʟ Aᴜᴅɪᴏ", callback_data="dual_info"),
            InlineKeyboardButton("Mᴜʟᴛɪ Aᴜᴅɪᴏ", callback_data="multi_info"),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            search = message.text
            m=await message.reply_sticker("CAACAgUAAxkBAAOYZerv7TNjcLrUv61o3nxjvPtl_v4AArwAA1jtnDHoq9OCuTSS9R4E")
            search = search.lower()
            find = search.split(" ")
            search = ""
